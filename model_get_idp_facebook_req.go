...
type _GetIdpFacebookReq GetIdpFacebookReq
...
func (o *GetIdpFacebookReq) UnmarshalJSON(bytes []byte) (err error) {
	varGetIdpFacebookReq := _GetIdpFacebookReq{}

	if err = json.Unmarshal(bytes, &varGetIdpFacebookReq); err == nil {
		*o = GetIdpFacebookReq(varGetIdpFacebookReq)
	}
...
type NullableGetIdpFacebookReq struct {
	value *GetIdpFacebookReq
	isSet bool
}

func (v NullableGetIdpFacebookReq) Get() *GetIdpFacebookReq {
	return v.value
}

func (v *NullableGetIdpFacebookReq) Set(val *GetIdpFacebookReq) {
	v.value = val
	v.isSet = true
}
...
func NewNullableGetIdpFacebookReq(val *GetIdpFacebookReq) *NullableGetIdpFacebookReq {
	return &NullableGetIdpFacebookReq{value: val, isSet: true}
}
