...
type _StoreIdpGoogleRes StoreIdpGoogleRes
...
func (o *StoreIdpGoogleRes) UnmarshalJSON(bytes []byte) (err error) {
	varStoreIdpGoogleRes := _StoreIdpGoogleRes{}

	if err = json.Unmarshal(bytes, &varStoreIdpGoogleRes); err == nil {
		*o = StoreIdpGoogleRes(varStoreIdpGoogleRes)
	}
...
type NullableStoreIdpGoogleRes struct {
	value *StoreIdpGoogleRes
	isSet bool
}

func (v NullableStoreIdpGoogleRes) Get() *StoreIdpGoogleRes {
	return v.value
}

func (v *NullableStoreIdpGoogleRes) Set(val *StoreIdpGoogleRes) {
	v.value = val
	v.isSet = true
}
...
func NewNullableStoreIdpGoogleRes(val *StoreIdpGoogleRes) *NullableStoreIdpGoogleRes {
	return &NullableStoreIdpGoogleRes{value: val, isSet: true}
}
