...
type _GetDbIdVaultRes GetDbIdVaultRes
...
func (o *GetDbIdVaultRes) UnmarshalJSON(bytes []byte) (err error) {
	varGetDbIdVaultRes := _GetDbIdVaultRes{}

	if err = json.Unmarshal(bytes, &varGetDbIdVaultRes); err == nil {
		*o = GetDbIdVaultRes(varGetDbIdVaultRes)
	}
...
type NullableGetDbIdVaultRes struct {
	value *GetDbIdVaultRes
	isSet bool
}

func (v NullableGetDbIdVaultRes) Get() *GetDbIdVaultRes {
	return v.value
}

func (v *NullableGetDbIdVaultRes) Set(val *GetDbIdVaultRes) {
	v.value = val
	v.isSet = true
}
...
func NewNullableGetDbIdVaultRes(val *GetDbIdVaultRes) *NullableGetDbIdVaultRes {
	return &NullableGetDbIdVaultRes{value: val, isSet: true}
}
