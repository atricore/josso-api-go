...
type _StoreIisExecEnvRes StoreIisExecEnvRes
...
func (o *StoreIisExecEnvRes) UnmarshalJSON(bytes []byte) (err error) {
	varStoreIisExecEnvRes := _StoreIisExecEnvRes{}

	if err = json.Unmarshal(bytes, &varStoreIisExecEnvRes); err == nil {
		*o = StoreIisExecEnvRes(varStoreIisExecEnvRes)
	}
...
type NullableStoreIisExecEnvRes struct {
	value *StoreIisExecEnvRes
	isSet bool
}

func (v NullableStoreIisExecEnvRes) Get() *StoreIisExecEnvRes {
	return v.value
}

func (v *NullableStoreIisExecEnvRes) Set(val *StoreIisExecEnvRes) {
	v.value = val
	v.isSet = true
}
...
func NewNullableStoreIisExecEnvRes(val *StoreIisExecEnvRes) *NullableStoreIisExecEnvRes {
	return &NullableStoreIisExecEnvRes{value: val, isSet: true}
}
