...
// UpdateIdPRes struct for UpdateIdPRes
type UpdateIdPRes struct {
...
type _UpdateIdPRes UpdateIdPRes
...
func (o UpdateIdPRes) MarshalJSON() ([]byte, error) {
...
func (o *UpdateIdPRes) UnmarshalJSON(bytes []byte) (err error) {
	varUpdateIdPRes := _UpdateIdPRes{}

	if err = json.Unmarshal(bytes, &varUpdateIdPRes); err == nil {
		*o = UpdateIdPRes(varUpdateIdPRes)
	}
...
type NullableUpdateIdPRes struct {
	value *UpdateIdPRes
	isSet bool
}

func (v NullableUpdateIdPRes) Get() *UpdateIdPRes {
	return v.value
}

func (v *NullableUpdateIdPRes) Set(val *UpdateIdPRes) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateIdPRes) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateIdPRes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateIdPRes(val *UpdateIdPRes) *NullableUpdateIdPRes {
	return &NullableUpdateIdPRes{value: val, isSet: true}
}

func (v NullableUpdateIdPRes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateIdPRes) UnmarshalJSON(src []byte) error {
	v.isSet = true
