...
type _ExternalSaml2ServiceProviderDTO ExternalSaml2ServiceProviderDTO
...
func NewExternalSaml2ServiceProviderDTO() *ExternalSaml2ServiceProviderDTO {
	this := ExternalSaml2ServiceProviderDTO{}
	return &this
}
...
func (o *ExternalSaml2ServiceProviderDTO) UnmarshalJSON(bytes []byte) (err error) {
	varExternalSaml2ServiceProviderDTO := _ExternalSaml2ServiceProviderDTO{}

	if err = json.Unmarshal(bytes, &varExternalSaml2ServiceProviderDTO); err == nil {
		*o = ExternalSaml2ServiceProviderDTO(varExternalSaml2ServiceProviderDTO)
	}
...
type NullableExternalSaml2ServiceProviderDTO struct {
	value *ExternalSaml2ServiceProviderDTO
	isSet bool
}

func (v NullableExternalSaml2ServiceProviderDTO) Get() *ExternalSaml2ServiceProviderDTO {
	return v.value
}

func (v *NullableExternalSaml2ServiceProviderDTO) Set(val *ExternalSaml2ServiceProviderDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableExternalSaml2ServiceProviderDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableExternalSaml2ServiceProviderDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExternalSaml2ServiceProviderDTO(val *ExternalSaml2ServiceProviderDTO) *NullableExternalSaml2ServiceProviderDTO {
	return &NullableExternalSaml2ServiceProviderDTO{value: val, isSet: true}
}
