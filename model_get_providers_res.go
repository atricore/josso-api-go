...
type _GetProvidersRes GetProvidersRes
...
func (o *GetProvidersRes) UnmarshalJSON(bytes []byte) (err error) {
	varGetProvidersRes := _GetProvidersRes{}

	if err = json.Unmarshal(bytes, &varGetProvidersRes); err == nil {
		*o = GetProvidersRes(varGetProvidersRes)
	}
...
type NullableGetProvidersRes struct {
	value *GetProvidersRes
	isSet bool
}

func (v NullableGetProvidersRes) Get() *GetProvidersRes {
	return v.value
}

func (v *NullableGetProvidersRes) Set(val *GetProvidersRes) {
	v.value = val
	v.isSet = true
}
...
func NewNullableGetProvidersRes(val *GetProvidersRes) *NullableGetProvidersRes {
	return &NullableGetProvidersRes{value: val, isSet: true}
}
