...
type _StoreIdpAzureRes StoreIdpAzureRes
...
func (o *StoreIdpAzureRes) UnmarshalJSON(bytes []byte) (err error) {
	varStoreIdpAzureRes := _StoreIdpAzureRes{}

	if err = json.Unmarshal(bytes, &varStoreIdpAzureRes); err == nil {
		*o = StoreIdpAzureRes(varStoreIdpAzureRes)
	}
...
type NullableStoreIdpAzureRes struct {
	value *StoreIdpAzureRes
	isSet bool
}

func (v NullableStoreIdpAzureRes) Get() *StoreIdpAzureRes {
	return v.value
}

func (v *NullableStoreIdpAzureRes) Set(val *StoreIdpAzureRes) {
	v.value = val
	v.isSet = true
}
...
func NewNullableStoreIdpAzureRes(val *StoreIdpAzureRes) *NullableStoreIdpAzureRes {
	return &NullableStoreIdpAzureRes{value: val, isSet: true}
}
