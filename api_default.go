...
type ApiGetIdSource1Request struct {
	ctx context.Context
	ApiService *DefaultApiService
	getIdSourcesReq *GetIdSourcesReq
}

func (r ApiGetIdSource1Request) GetIdSourcesReq(getIdSourcesReq GetIdSourcesReq) ApiGetIdSource1Request {
	r.getIdSourcesReq = &getIdSourcesReq
	return r
}

func (r ApiGetIdSource1Request) Execute() (*GetIdSourcesRes, *http.Response, error) {
	return r.ApiService.GetIdSource1Execute(r)
}

/*
GetIdSource1 Method for GetIdSource1

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetIdSource1Request
*/
func (a *DefaultApiService) GetIdSource1(ctx context.Context) ApiGetIdSource1Request {
	return ApiGetIdSource1Request{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DefaultApiService) GetIdSource1Execute(r ApiGetIdSource1Request) (*GetIdSourcesRes, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.GetIdSource1")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
