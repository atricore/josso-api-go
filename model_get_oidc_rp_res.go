...
type _GetOidcRpRes GetOidcRpRes
...
func (o *GetOidcRpRes) UnmarshalJSON(bytes []byte) (err error) {
	varGetOidcRpRes := _GetOidcRpRes{}

	if err = json.Unmarshal(bytes, &varGetOidcRpRes); err == nil {
		*o = GetOidcRpRes(varGetOidcRpRes)
	}
...
func (v NullableGetOidcRpRes) Get() *GetOidcRpRes {
	return v.value
}
...
func NewNullableGetOidcRpRes(val *GetOidcRpRes) *NullableGetOidcRpRes {
	return &NullableGetOidcRpRes{value: val, isSet: true}
}
