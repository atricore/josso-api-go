...
type _GetIdpGoogleRes GetIdpGoogleRes
...
func (o *GetIdpGoogleRes) UnmarshalJSON(bytes []byte) (err error) {
	varGetIdpGoogleRes := _GetIdpGoogleRes{}

	if err = json.Unmarshal(bytes, &varGetIdpGoogleRes); err == nil {
		*o = GetIdpGoogleRes(varGetIdpGoogleRes)
	}
...
type NullableGetIdpGoogleRes struct {
	value *GetIdpGoogleRes
	isSet bool
}

func (v NullableGetIdpGoogleRes) Get() *GetIdpGoogleRes {
	return v.value
}

func (v *NullableGetIdpGoogleRes) Set(val *GetIdpGoogleRes) {
	v.value = val
	v.isSet = true
}
...
func NewNullableGetIdpGoogleRes(val *GetIdpGoogleRes) *NullableGetIdpGoogleRes {
	return &NullableGetIdpGoogleRes{value: val, isSet: true}
}
